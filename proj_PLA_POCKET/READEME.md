...
( 2 ) points2000.py 創造 1000筆正例( 1 ) 1000筆反例( -1 ) 以 f(x)線性分割 ( 3 ) miss.py 創造 1000 筆正例( 1 ) 1000筆反例( -1 ) 兩者都有各 50 筆標示錯

誤共 100筆錯誤

( 4 ) pla.pyPLA 演算法，當資料線性可分割會自動停止，不可分割最多迭代 10

萬次

( 5 ) pocket.pyPocket 演算法，當資料線性可分割會自動停止，不可分割最多迭
